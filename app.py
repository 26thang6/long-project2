...
if choice == 'About Coursera':
    ...
    # URL to link to
    url = 'https://www.coursera.org/about/partners'

    # HTML and CSS for displaying full-width clickable image
    st.markdown(
        f"""
        <style>
            .full-width-image {{
        ...
        <a href="{url}" target="_blank">
            <img src="IMG_6121.png" class="full-width-image" alt="Coursera Partners">
        </a>
        """,
